...
class Command {
  ...
  geoNear(Point geometry, {num? maxDistance, num? minDistance}) {
    ...
    return _queryOP(QueryCommandsLiteral.GEO_NEAR, params);
  }
  ...
  geoWithin(geometry) {
    ...
    return _queryOP(QueryCommandsLiteral.GEO_WITHIN, {'geometry': geometry});
  }
  ...
  geoIntersects(geometry) {
    ...
    return _queryOP(
        QueryCommandsLiteral.GEO_INTERSECTS, {'geometry': geometry});
  }
